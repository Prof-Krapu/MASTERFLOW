...
- Statut : R5.1-R5.2 sur `main`; R5.3 validation interne en recette locale.
...
- Statut : R4.1-R4.4 sur `main`; validation auteur d’un patch candidat à suivre, sans application automatique.
