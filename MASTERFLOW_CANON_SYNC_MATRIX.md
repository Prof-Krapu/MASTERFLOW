...
Branche de travail : `codex/roster-foundation-v1`
Base GitHub vérifiée : `b385ee3`
...
| D06 correction / feedback | partiel | Feedback et preview privée sont sur `main`; cohorte/roster versionnés sont vérifiés localement mais pas encore reliés au snapshot de correction. | moyen | Merger le roster puis ajouter le snapshot immuable roster/sujet/barème/source. |
