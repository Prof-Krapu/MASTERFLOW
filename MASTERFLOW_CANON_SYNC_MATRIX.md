...
Branche de travail : `codex/factory-backflow-intake-v6c`
Base GitHub vérifiée : `3e82b87`
...
| D11 factories/backflow | partiel | Usage Harvester V6B est sur `main`. V6C ajoute localement l'intake manuel JSON Passport+Export, Inbox admin/godmode et quarantaine ; ZIP, fichiers, URL, import et activation restent absents. | moyen | Publier V6C puis conserver toute installation/simulation réelle comme tranche séparée. |
