...
| D09 MasterStory | partiel | R4.1-R4.5 sur `main` : workbench privé, reader state, patches candidats et validation auteur. Contrôle UI R4.6 en recette locale ; canon delta/export absents. | moyen | Publier le contrôle auteur puis fermer le lot privé sans appliquer de delta ni muter la source. |
