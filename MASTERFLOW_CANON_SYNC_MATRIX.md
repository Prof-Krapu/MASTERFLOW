...
Branche de travail : `main` après PR #62
Base GitHub vérifiée : `53efad0`
...
| D06 correction / feedback | partiel | Roster, snapshot, enforcement et payload privé sont sur `main` (PR #59-62). | moyen | Relier chaque submission à une identité du roster, puis fournir l'UI professeur. |
