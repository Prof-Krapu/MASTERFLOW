...
| D12 owner observability et continuité | partiel | Cockpit, findings, décisions owner, Usage Harvester V1 et registre release/SHA R5.1 sont sur `main`; panneau R5.2 en recette locale. Live, backup/recovery et smoke restent non prouvés. | moyen | Publier le panneau privé sans transformer déclaration ou preuve attachée en statut live vérifié. |
