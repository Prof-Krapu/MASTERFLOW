...
Branche de travail : `main` après PR #67
Base GitHub vérifiée : `4ccda9a`
...
| D06 correction / feedback | partiel | Contexte, liaison explicite, candidates ambiguës et UI professeur de revue sont sur `main` (PR #59-67). | faible à moyen | Ouvrir la gestion manuelle cohortes/rosters. |
