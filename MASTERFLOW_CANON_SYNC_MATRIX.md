...
| D12 owner observability et continuité | partiel | Cockpit, findings, décisions owner, Usage Harvester V1 et rail release/SHA R5.1-R5.2 sont sur `main`. Live, backup/recovery et smoke restent non prouvés. | moyen | Considérer le rail release receipt clos ; toute continuité hôte reste derrière un contrat et des preuves séparés. |
