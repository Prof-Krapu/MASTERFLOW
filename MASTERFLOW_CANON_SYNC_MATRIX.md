...
Branche de travail : `main` après PR #65
Base GitHub vérifiée : `7195a20`
...
| D06 correction / feedback | partiel | Contexte, liaison explicite et candidates ambiguës sont sur `main` (PR #59-65). | moyen | Exposer la revue dans l'UI professeur. |
