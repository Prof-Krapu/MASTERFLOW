...
Branche de travail : `codex/identity-review-ui-v1`
Base GitHub vérifiée : `3ff628c` (main après clôture Identity Resolution V1)
...
| D06 correction / feedback | partiel | Contexte, liaison explicite et candidates ambiguës sont sur `main` ; l'UI professeur de revue est vérifiée localement. | faible à moyen | Publier l'UI puis ouvrir la gestion manuelle cohortes/rosters. |
