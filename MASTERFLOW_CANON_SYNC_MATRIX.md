...
| Context hash / re-preflight | partiel local | Snapshot privé et comparateur read-only existent ; seules les refs avec révision fiable sont comparées. | faible | Publier, puis décider les familles qui imposeraient réellement stale ou re-preflight. |
