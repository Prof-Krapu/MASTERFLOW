...
| D09 MasterStory | partiel | R4.1-R4.4 sur `main` : workbench privé, reader state et patches candidats. Validation auteur R4.5 en recette locale ; canon delta/export absents. | moyen | Publier la validation auteur privée sans appliquer de delta ni muter la source. |
