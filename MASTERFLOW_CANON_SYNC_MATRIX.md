...
| Experience Fabric / Living Companion Robot CDC | implémenté local | Projection guidée depuis session CDC, progression et storylets ; aucune évolution ou génération d'asset. | faible | Valider et publier la tranche 6.1, puis réutiliser le contrat pour MOTH. |
