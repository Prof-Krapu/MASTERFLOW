...
Branche de travail : `codex/correction-context-payload-v1`
Base GitHub vérifiée : `a5fca40`
...
| D06 correction / feedback | partiel | Roster, snapshot et enforcement sont sur `main`; payload privé roster/sujet/barème/sources localement vérifié. | moyen | Merger le payload puis relier chaque submission à une identité du roster. |
