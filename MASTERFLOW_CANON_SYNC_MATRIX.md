...
| D12 owner observability et continuité | partiel | Cockpit, findings, décisions owner, Usage Harvester V1 et rail release/SHA R5.1-R5.2 sont sur `main`; backup receipt R5.3 en recette locale. Live, backup/recovery et smoke restent non prouvés. | moyen | Publier la trace de backup sans exécuter ni présumer une restauration ; toute action hôte reste derrière un contrat séparé. |
