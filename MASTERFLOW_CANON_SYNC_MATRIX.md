...
Branche de travail : `codex/d08-visual-manifest-registry` — R3.1 en recette manifest-first
Base GitHub vérifiée : `0592740` (`main` après PR #103)
...
| D08 génération visuelle | partiel local | R3.1 ajoute références et manifests privés avec rapport Action Ready ; provider, storage, asset lifecycle et review restent absents. | moyen | Publier R3.1, puis ajouter une surface owner read-only avant toute exécution. |
