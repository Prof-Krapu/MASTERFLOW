...
Branche de travail : `codex/correction-context-snapshot-v1`
Base GitHub vérifiée : `236add0`
...
| D06 correction / feedback | partiel | Feedback/preview et roster sont sur `main`; snapshot immuable roster/sujet/barème/source vérifié localement. | moyen | Merger le snapshot puis l'exiger dans le manifest/run de pré-correction. |
