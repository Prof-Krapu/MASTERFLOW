...
Branche de travail : `codex/r2-safe-teacher-sheet-editing` — R2.6 correctif en recette
Base GitHub vérifiée : `977e870` (`main` après PR #101)
...
| D06 correction / feedback | partiel | R1 atteint le manifest professeur sans runner ; R2.3-R2.5 sont sur `main`. R2.6 corrige localement l’isolation des formulaires professeur. | faible à moyen | Publier R2.6 puis clôturer la verticale R2 privée. |
