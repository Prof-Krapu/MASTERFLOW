...
| D12 owner observability et continuité | partiel | Cockpit, findings, décisions owner et Usage Harvester V1 sont sur `main` ; registre release/SHA R5.1 en recette locale. Live, backup/recovery et smoke restent non prouvés. | moyen | Publier le registre privé sans transformer déclaration ou preuve attachée en statut live vérifié. |
