...
| D10 événements/devis/public | partiel | Quote Builder privé sourcé et validation interne publiés sur `main`; contrôle UI R5.4 en publication. Public intake, export, envoi et facture absents. | moyen | Terminer R5.4 puis fermer D10 privé ; garder toute sortie derrière validation produit. |
