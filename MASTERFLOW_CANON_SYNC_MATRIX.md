...
| D11 factories/backflow | partiel | Usage Harvester V6B et V6C sont sur `main` : intake manuel JSON Passport+Export, Inbox admin/godmode et quarantaine. ZIP, fichiers, URL, import, installation et activation restent absents. | moyen | Conserver toute installation/simulation réelle comme tranche séparée et validée. |
