...
Statut : baseline historique restaurée, remplacée par `MASTERFLOW_UI_INTEGRATION_REGISTRY_V2.md`
Owner : MALEX
Date : 2026-07-04
...
> Note de reprise du 2026-08-02 : ce registre conserve la photographie validée avant les merges
> UI #221 à #224. Ses statuts et sa queue ne pilotent plus le travail courant ; le registre V2
> réconcilie cette baseline avec `main` au SHA `29f08287db1893b2a535c13dbf684e0185546057`.
