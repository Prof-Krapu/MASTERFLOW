...
|---|---|---|---|---|---|
| `CORRECTOR_APP_RUNTIME` + student monitoring | D05/D06 | contrat classe/cohorte/roster/context ajouté au Living Truth Spine | roster + snapshot sur main ; enforcement manifest/run local vérifié | implemented_partial | merger l'enforcement puis compiler le payload privé du runner |
