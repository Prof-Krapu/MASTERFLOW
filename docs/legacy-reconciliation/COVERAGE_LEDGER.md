...
|---|---|---|---|---|---|
| `CORRECTOR_APP_RUNTIME` + student monitoring | D05/D06 | contrat classe/cohorte/roster/context ajouté au Living Truth Spine | contexte + liaison + candidates ambiguës sur main (PR #59-65), UI professeur vérifiée localement | implemented_partial | publier l'UI puis ouvrir la gestion manuelle cohortes/rosters |
