...
|---|---|---|---|---|---|
| `CORRECTOR_APP_RUNTIME` + student monitoring | D05/D06 | contrat classe/cohorte/roster/context ajouté au Living Truth Spine | contexte + liaison + candidates ambiguës sur main (PR #59-65) | implemented_partial | UI professeur de revue des identités |
