...
|---|---|---|---|---|---|
| `CORRECTOR_APP_RUNTIME` + student monitoring | D05/D06 | contrat classe/cohorte/roster/context ajouté au Living Truth Spine | résolution d'identité sur main ; gestion manuelle cohortes/rosters vérifiée localement | implemented_partial | publier la gestion roster puis ouvrir le lancement manuel d'un lot de correction contextualisé |
