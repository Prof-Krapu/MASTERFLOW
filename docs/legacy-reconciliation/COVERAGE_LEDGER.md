...
|---|---|---|---|---|---|
| `CORRECTOR_APP_RUNTIME` + student monitoring | D05/D06 | contrat classe/cohorte/roster/context ajouté au Living Truth Spine | roster sur main ; snapshot correction immuable localement vérifié | implemented_partial | merger le snapshot puis l'exiger dans pre-correction manifest/run |
