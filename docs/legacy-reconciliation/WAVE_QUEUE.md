...
3. **People & Learning Spine** — organisation, classe, cohorte, roster, identité, suivi pédagogique. **Contexte et résolution d'identité V1 sur main (PR #59-65), UI professeur vérifiée localement** ; publication puis gestion manuelle cohortes/rosters, migration réelle gated.
...
7. **Domain restores** — Story, public/devis, inventory, HelpLab et apps restantes, seulement après le socle. **Index actif restauré** ; prochaines apps par analyse de gap ciblée.
