...
3. **People & Learning Spine** — organisation, classe, cohorte, roster, identité, suivi pédagogique. **Roster + snapshot sur main, enforcement run local vérifié** ; compilateur privé suivant, migration réelle gated.
