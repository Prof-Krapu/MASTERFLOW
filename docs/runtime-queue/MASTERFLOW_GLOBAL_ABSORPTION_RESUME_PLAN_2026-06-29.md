...
| 2 | Security Fabric | Formaliser injection, RAG poisoning, permissions, sources non fiables et actions sensibles | contract_ready_pr_176 | contrat V1 puis garde déterministe partagé, sans provider/live |
