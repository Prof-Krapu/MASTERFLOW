...
| 11 | Red Team / Tests | Couvrir prompt injection, permissions, révocation, poisoning, UI safety states | red_team_tests_002_local | sécurité/RAG/Safety publiée ; auth/révocation vérifiée localement ; permissions router/UI safety restent à poursuivre |
