...
| 4 | Safety State Machine narrative | Créer états de recadrage, suspicion, fermeture, hard stop et rétablissement | runtime_projection_ready_local | projection pure et privée, sans ban automatique |
| 5 | Voice / Persona Voice | Auditer TTS existant et raccorder aux personas sans moteur concurrent | next_not_started | P1 TTS contrôlé, whitelist, limites et permissions ; STT reste futur |
