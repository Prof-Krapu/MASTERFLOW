...
| 2 | Security Fabric | Formaliser injection, RAG poisoning, permissions, sources non fiables et actions sensibles | contract_ready_local | contrat V1 puis garde déterministe partagé, sans provider/live |
