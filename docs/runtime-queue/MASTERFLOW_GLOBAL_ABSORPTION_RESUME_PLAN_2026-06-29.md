...
| 3 | Trust Fabric | Séparer confiance utilisateur, source, lien/fichier et charge système/provider | contract_ready_local | dimensions séparées puis read model calculé depuis l'existant |
