...
| 11 | Red Team / Tests | Couvrir prompt injection, permissions, révocation, poisoning, UI safety states | red_team_tests_001_local | première tranche sécurité/RAG/Safety vérifiée localement ; permissions/révocation/UI safety restent à poursuivre |
