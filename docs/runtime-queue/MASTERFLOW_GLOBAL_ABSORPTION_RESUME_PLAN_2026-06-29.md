...
| 11 | Red Team / Tests | Couvrir prompt injection, permissions, révocation, poisoning, UI safety states | red_team_tests_002_merged | sécurité/RAG/Safety et auth/révocation publiées ; permissions router/UI safety restent à poursuivre |
