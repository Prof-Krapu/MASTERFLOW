...
| 1 | Plan d'absorption canonique | Classer audits BP, legacy, factories, OpenMontage/design, voix, sécurité et DA narrative | active_local | matrice déjà représenté / candidat / à intégrer / futur / rejeté / bloqué |
| 2 | Security Fabric | Formaliser injection, RAG poisoning, permissions, sources non fiables et actions sensibles | next | contrat + tests candidats, sans provider/live |
