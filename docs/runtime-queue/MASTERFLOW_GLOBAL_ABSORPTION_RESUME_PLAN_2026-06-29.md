...
| 2 | Security Fabric | Formaliser injection, RAG poisoning, permissions, sources non fiables et actions sensibles | next_not_started | contrat + tests candidats, sans provider/live |
