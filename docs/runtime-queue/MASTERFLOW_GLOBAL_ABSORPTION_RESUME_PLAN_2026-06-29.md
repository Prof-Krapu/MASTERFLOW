...
| 7 | Theme Studio / DA / Assets | Piloter thèmes, typos, palettes, assets, lore et versions événementielles | activation_preflight_ready_local | preview pack + préflight d'activation validable ; application réelle encore bloquée |
