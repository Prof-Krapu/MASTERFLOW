...
| 9 | UI progressive | Home légère puis surfaces Teaching, Learn, GodMode, Theme Studio, MasterStory | ui_004_teaching_cockpit_local_verified | cockpit Teaching validé localement ; publication puis projection classe/subpersona |
