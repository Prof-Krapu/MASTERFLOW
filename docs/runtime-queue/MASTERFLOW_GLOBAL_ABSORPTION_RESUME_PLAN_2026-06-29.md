...
| 5 | Voice / Persona Voice | Auditer TTS existant et raccorder aux personas sans moteur concurrent | contract_ready_local | P1 TTS contrôlé, whitelist, limites et permissions ; STT reste futur |
