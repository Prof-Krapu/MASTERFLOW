...
| Safety narrative states | `contract_ready_pr_180` | sept états, transitions, récupération, hard stop et réactions persona sémantiques | humiliation en classe, sanction automatique, état caché, asset improvisé | `SAFETY-STATE-002` projection pure |
