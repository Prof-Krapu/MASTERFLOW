...
| Red Team / tests | `red_team_tests_001_local` | tests percent-encoding, scope escape, tool misuse, markup caché, RAG obfusqué et priorité hard-stop | faux sentiment de sécurité sans couvrir permissions/révocation/UI safety | publier, puis poursuivre les trous restants par tranches courtes |
