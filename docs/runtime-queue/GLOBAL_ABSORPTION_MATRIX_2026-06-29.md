...
| Security Fabric | `runtime_guard_ready_local` | frontière V1, garde déterministe direct/indirect, RAG fiable, action engine, hard stop, permissions | répétition persistante, ban automatique, kill switch global, provider/live | `TRUST-FABRIC-001`, puis observabilité sécurité |
