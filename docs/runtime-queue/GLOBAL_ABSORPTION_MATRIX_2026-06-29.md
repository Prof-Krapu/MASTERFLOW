...
| DA narrative / Theme Studio / D08 | `asset_pack_preview_pr_186` | manifests, visual grammar, Theme Studio explain-only, D08 gates, autorités de routage, ThemePack preview | provider image réel, canonisation auto, motif décoratif non justifié, application silencieuse | `THEME-STUDIO-ACTIVATION-PREFLIGHT-001` |
