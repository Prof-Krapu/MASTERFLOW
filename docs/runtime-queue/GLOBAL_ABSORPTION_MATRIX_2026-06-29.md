...
| UI progressive | `ui_002_persona_rail_pr_201_merged` | Home légère, GodMode panels, outils à la demande, Teaching/Learning, persona rail et chat extensible | dashboard permanent, chargement massif, persona invité fictif, asset présenté comme canon sans preuve | construire la page complète adaptative |
