...
| DA narrative / Theme Studio / D08 | `bridge_map_pr_184_merged` | manifests, visual grammar, Theme Studio explain-only, D08 gates, autorités de routage | provider image réel, canonisation auto, motif décoratif non justifié | `THEME-STUDIO-ASSET-PACKS-001` |
