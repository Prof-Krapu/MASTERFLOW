...
| UI progressive | `ui_005_class_projection_local_verified` | Home, persona/chat, Project, Teaching et projection d'un Living Companion assigné | subpersona fictif, micro présenté live, asset provisoire présenté canon, dialogue autonome | publier UI-005 puis préparer cockpit étudiant |
