...
| UI progressive | `ui_004_teaching_cockpit_local_verified` | Home, persona/chat, page Project et cockpit Teaching fondé sur les runtimes existants | météo collective inventée, formulaires lourds au premier niveau, généralisation sans validation | publier UI-004 puis préparer projection classe/subpersona |
