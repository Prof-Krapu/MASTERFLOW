...
| UI progressive | `ui_003_adaptive_project_page_pr_203_merged` | Home légère, Teaching/Learning, persona rail, chat extensible et cadre de page objet appliqué à Project | dashboard permanent, généralisation avant validation, préférence persistante inventée, asset canon sans preuve | construire Teaching cockpit |
