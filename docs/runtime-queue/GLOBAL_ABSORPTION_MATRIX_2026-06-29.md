...
| Voix / TTS persona | `contract_ready_local` + PoC | route et bouton existent ; contrat auth/Room/whitelist/limites prêt | STT, clonage, voix libre, provider payant, cache audio | `VOICE-PERSONA-002` durcissement mocké |
