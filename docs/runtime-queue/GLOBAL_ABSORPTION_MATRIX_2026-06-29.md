...
| Security Fabric | `partial_runtime` | RAG anti-injection, action engine, hard stop, permissions | ban automatique, kill switch global, self-debug, provider/live | `SECURITY-FABRIC-001` immédiate |
