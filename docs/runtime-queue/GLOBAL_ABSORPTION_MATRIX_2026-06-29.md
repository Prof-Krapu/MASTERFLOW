...
| Trust Fabric | `runtime_read_model_ready_local` | quatre dimensions séparées, lecture privée, trust RAG, audit, coûts et santé runtime | passeport artifact, score moral, moyenne globale, surveillance opaque | `SAFETY-STATE-001`, puis passeport artifact séparé |
