...
| UI progressive | `ui_003_adaptive_project_page_local_verified` | Home légère, Teaching/Learning, persona rail, chat extensible et cadre de page objet appliqué à Project | dashboard permanent, généralisation avant validation, préférence persistante inventée, asset canon sans preuve | publier UI-003 puis préparer Teaching cockpit |
