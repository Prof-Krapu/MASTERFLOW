...
| UI progressive | `ui_005_class_projection_pr_207_merged` | Home, persona/chat, Project, Teaching et projection d'un Living Companion assigné | subpersona fictif, micro présenté live, asset provisoire présenté canon, dialogue autonome | construire cockpit projet étudiant |
