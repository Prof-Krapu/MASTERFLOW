...
| UI progressive | `ui_004_teaching_cockpit_pr_205_merged` | Home, persona/chat, page Project et cockpit Teaching fondé sur les runtimes existants | météo collective inventée, formulaires lourds au premier niveau, généralisation sans validation | auditer puis construire projection classe/subpersona |
