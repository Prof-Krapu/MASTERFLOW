...
| Safety narrative states | `runtime_projection_ready_local` | sept états, projection privée, récupération, hard stop et réactions sémantiques | humiliation en classe, sanction automatique, asset improvisé, UI punitive | `VOICE-PERSONA-001`, puis surface UI séparée |
