...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    next: {kind: 'route_to_validation_inbox', label: 'Consigner puis relire la finding sans auto-fix', reason: 'La finding et sa revue existent ; la détection du raté reste encore manuelle.', required_validation: false, forbidden_followups: ['auto_patch', 'auto_canon']},
    missed: {expected_process: 'd12_finding', missing_runtime_piece: 'automatic_missed_trigger_detection', user_impact: 'Le raté peut être suivi, mais doit encore être signalé manuellement.', suggested_queue_task: 'Brancher plus tard une détection bornée sur des événements internes sourcés.', severity: 'medium'},
    confidence: 0.82,
