import {CreateVisualManifestRequestSchema, CreateVisualReferenceRequestSchema} from '@masterflow/shared';
import {Router, type Request, type Response} from 'express';

import {requireRole, requireUser, type AuthUser} from '../middleware/auth.ts';
import {createVisualManifest, createVisualReference, listVisualManifests, listVisualReferences} from '../services/visual_manifests.ts';
