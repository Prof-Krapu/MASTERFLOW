...
Déclarer les entrées pédagogiques que MasterFlow pourra absorber sans prétendre que leurs
runners existent déjà.
...
Tous exigent au minimum le rôle `teacher`. Aucun n'a de `executor_ref`.
...
- garde : `requireExecutableAdapter` refuse actuellement les quatre adapters ;
